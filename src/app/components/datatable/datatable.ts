...
import {Column,Header,Footer,HeaderColumnGroup,FooterColumnGroup,PrimeTemplate} from 'primeng/shared';
/* Deprecated */
// import {Column,HeaderColumnGroup,FooterColumnGroup} from 'primeng/shared';

import {LazyLoadEvent, FilterMetadata, SortMeta, BlockableUI} from 'primeng/api';
...
export class ScrollableView implements AfterViewInit,AfterViewChecked,OnDestroy {
    ...
    @ViewChild('scrollHeader', null) scrollHeaderViewChild: ElementRef;
    
    @ViewChild('scrollHeaderBox', null) scrollHeaderBoxViewChild: ElementRef;
    
    @ViewChild('scrollBody', null) scrollBodyViewChild: ElementRef;
    
    @ViewChild('scrollTable', null) scrollTableViewChild: ElementRef;
    
    @ViewChild('scrollTableWrapper', null) scrollTableWrapperViewChild: ElementRef;
    
    @ViewChild('scrollFooter', null) scrollFooterViewChild: ElementRef;
    
    @ViewChild('scrollFooterBox', null) scrollFooterBoxViewChild: ElementRef;
...
export class DataTable implements AfterViewChecked,AfterViewInit,AfterContentInit,OnInit,OnDestroy,BlockableUI {
    ...
    @ContentChild(Header, null) header;

    @ContentChild(Footer, null) footer;
